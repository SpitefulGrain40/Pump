...
export const WORKOUT_TEMPLATES = {
  push: {
    ...
    exercises: [
      { name: 'Landmine Press', sets: 3, reps: 10, weight: '20-25kg', notes: 'Neutral spine, no shrug' },
      { name: 'DB Incline Press', sets: 3, reps: 10, weight: '32kg each', notes: '45° incline' },
      { name: 'DB Lateral Raises', sets: 3, reps: 12, weight: '10-12kg', notes: 'Slight forward lean' },
      { name: 'DB Chest Flyes', sets: 3, reps: 12, weight: '16-18kg', notes: 'Flat or incline' },
      { name: 'Tricep Pushdowns', sets: 3, reps: 12, weight: 'Band/heavy', notes: 'Elbows tucked' },
    ],
  ...
  pull: {
    ...
    exercises: [
      { name: 'Landmine Row', sets: 3, reps: 10, weight: '35kg plate', notes: 'Brace core, neutral spine' },
      { name: 'TRX Row', sets: 3, reps: 12, weight: 'Bodyweight', notes: 'Feet forward = harder' },
      { name: 'TRX Bicep Curl', sets: 3, reps: 10, weight: 'Bodyweight', notes: 'Neutral grip' },
      { name: 'Hammer Curl', sets: 3, reps: 8, weight: '20kg each', notes: 'Neutral grip, elbow care' },
      { name: 'Band Face Pulls', sets: 3, reps: 15, weight: 'Medium band', notes: 'Pull to nose height' },
    ],
    finisher: 'SB Strength App — 15-20 min',
    cooldown: [],
    evening: {
